      ...
      <section className="profile-hero shell">
        ...
        <div className="profile-copy">
          ...
          <div className="profile-facts">
            <span>ЕГЭ по информатике — 85</span><span>1–9 класс</span><span>Онлайн и офлайн</span>
          </div>
        </div>
      </section>
      ...
      <section className="profile-story shell">
        ...
        <div className="about-intro">
          ...
          <div className="about-copy">
            ...
            <p>Преподавание для меня — семейное дело: в нашей семье учителя уже не в первом поколении. Несколько лет назад я в течение года преподавала математику в мини-группах в детском центре «Талантия». Также у меня есть опыт преподавания английского языка в небольших группах и два года работы администратором в этом центре. Сейчас уже не первый год работаю репетитором индивидуально.</p>
            <p>Этот опыт помогает мне легко находить общий язык с учениками, держать структуру занятия и выстраивать понятную систему обучения под каждого ребёнка.</p>
