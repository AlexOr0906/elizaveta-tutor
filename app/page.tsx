      ...
      <section className="profile-story shell">
        ...
        <div className="about-intro">
          ...
          <div className="about-copy">
            ...
            <p className="about-experience">Несколько лет назад я в течение года преподавала математику в мини-группах в детском центре «Талантия». Также у меня есть опыт преподавания английского языка в небольших группах и два года работы администратором в этом центре.</p>
            <p className="about-current">Сейчас уже не первый год работаю репетитором индивидуально.</p>
            <p className="about-method">Этот опыт помогает мне легко находить общий язык с учениками, держать структуру занятия и выстраивать понятную систему обучения под каждого ребёнка.</p>
