      ...
      <section className="profile-story shell">
        ...
        <div className="about-intro">
          ...
          <div className="about-copy">
            ...
            <p>Преподавание для меня — семейное дело: в нашей семье учителя уже не в первом поколении. Несколько лет назад я в течение года преподавала математику в мини-группах в детском центре «Талантия».<br /><br />Также у меня есть опыт преподавания английского языка в небольших группах и два года работы администратором в этом центре. Сейчас уже не первый год работаю репетитором индивидуально.</p>
