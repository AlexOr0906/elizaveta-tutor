      ...
      <section className="profile-story shell">
        ...
        <div className="about-intro">
          ...
          <div className="about-copy">
            ...
            <p>Преподавание для меня — семейное дело: в нашей семье учителя уже не в первом поколении. Несколько лет назад я в течение года преподавала математику в мини-группах в детском центре «Талантия». Сейчас уже не первый год работаю репетитором индивидуально.</p>
